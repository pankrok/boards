...
if (($_POST)) {
    createAdmin();
    echo '<div class="col-12"><div class="message blue">Admin created!<span class="message-close" aria-hidden="true">&times;</span></div></div>';
    $next = true;
}
...
<div class="col-12 text-justify p-4">
    ...
    echo $_POST['password'];
	  ...
	  <input type="password" name="passwordv" value="<?php if (isset($_POST['passwordv'])) {
    echo $_POST['passwordv'];
} ?>">
	  <?php if (!$next) {
    echo'
				<br><br>
