...
--
-- Table structure for table `brd_additional_fields`
--
...
--
-- Table structure for table `brd_admin_logs`
--
...
--
-- Table structure for table `brd_conversations`
--

CREATE TABLE `brd_conversations` (
  `id` int(11) NOT NULL,
  `admin` tinyblob,
  `users` mediumblob,
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
--
-- Table structure for table `brd_mail_logs`
--
...
--
-- Table structure for table `brd_pages`
--
...
--
-- Dumping data for table `brd_pages`
--
...
--
-- Table structure for table `brd_rates`
--
...
--
-- Table structure for table `brd_user_additional_fields`
--
...
--
-- Indexes for table `brd_additional_fields`
--
ALTER TABLE `brd_additional_fields`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `brd_admin_logs`
--
...
--
-- Indexes for table `brd_conversations`
--
ALTER TABLE `brd_conversations`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `brd_mail_logs`
--
...
--
-- Indexes for table `brd_user_additional_fields`
--
...
--
-- AUTO_INCREMENT for table `brd_additional_fields`
--
ALTER TABLE `brd_additional_fields`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `brd_admin_logs`
--
ALTER TABLE `brd_admin_logs`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `brd_conversations`
--
ALTER TABLE `brd_conversations`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `brd_mail_logs`
--
ALTER TABLE `brd_mail_logs`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `brd_rates`
--
ALTER TABLE `brd_rates`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `brd_user_additional_fields`
--
ALTER TABLE `brd_user_additional_fields`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- Constraints for table `brd_admin_logs`
--
ALTER TABLE `brd_admin_logs`
...
ALTER TABLE `brd_mailbox`
  ...
  ADD CONSTRAINT `brd_mailbox_ibfk_3` FOREIGN KEY (`conversation_id`) REFERENCES `brd_conversations` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `brd_message`
--
ALTER TABLE `brd_message`
  ADD CONSTRAINT `brd_message_ibfk_1` FOREIGN KEY (`conversation_id`) REFERENCES `brd_conversations` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
...
--
-- Constraints for table `brd_rates`
--
ALTER TABLE `brd_rates`
...
--
-- Constraints for table `brd_user_additional_fields`
--
ALTER TABLE `brd_user_additional_fields`
