...
INSERT INTO `skins_boxes` (`id`, `skin_id`, `box_id`, `side`, `box_order`, `active`) VALUES
...
--
ALTER TABLE `skins_boxes`
  ADD CONSTRAINT `skins_boxes_ibfk_1` FOREIGN KEY (`skin_id`) REFERENCES `skins` (`id`) ON DELETE CASCADE ON UPDATE NO ACTION,
