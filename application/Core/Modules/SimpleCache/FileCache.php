...
class FileCache extends Cache
{
    ...
    */
    ...
    {
        try {
            $content = @file_get_contents($this->path . DIRECTORY_SEPARATOR . md5($key) . $this->extension);
            if ($content === false) {
                return $default;
            }
    ...
    */
    public function set($key, $value, $ttl = null)
    {
        ...
        try {
            ...
            file_put_contents($this->path . DIRECTORY_SEPARATOR . md5($key) . $this->extension, $content);
            return true;
        } catch (\Exception $e) {
            throw new \Psr\SimpleCache\InvalidArgumentException($key);
        }
    ...
    {
        return file_exists($this->path . DIRECTORY_SEPARATOR . md5($key) . $this->extension);
    }
}
