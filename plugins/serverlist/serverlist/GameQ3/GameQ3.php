...
class GameQ3
{
    ...
    public function addServer($server_info)
    {
        ...
        $protocol_class = "\\Plugins\\ServerList\\serverlist\\GameQ3\\Protocols\\".ucfirst($server_info['type']);
    ...
    private function _request()
    {
        ...
        while (true) {
            ...
            foreach ($response as $sid => $ra) {
                if (empty($ra['p']) || !isset($process[$sid])) {
                    continue;
                }
